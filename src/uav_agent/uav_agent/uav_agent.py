...
from .tools import uav_simple as uav_tools
...
class UAVAgent(ROSA):
    ...
    def __init__(self, streaming: bool = True, verbose: bool = True):
        ...
        super().__init__(
            ...
            llm=self.__llm,
            tools=[flight_pattern_square, flight_pattern_circle, hover_tool] + uav_tool_list,
        ...
        self.examples = [
            ...
            "Move left 2 seconds, then move right 2 seconds",
            "Execute a square flight pattern",
